    ...
    <SafeAreaView className="bg-white flex-1">
      <ScrollView>
        ...
        <View className="w-full bg-gray-200" style={{ height: 220 }}>
          <Image
            source={{ uri: "https://via.placeholder.com/800x200.png" }}
        ...
        {/* Avatar overlapping */}
        <View className="px-4 -mt-12  z-10 flex-row items-center">
          {/* Avatar */}
          <Image
        ...
        <View className="px-4 mt-4">
          <AppText weight="bold" className="text-xl">Company / Organization Name</AppText>
