            ...
            <ScrollView>
                ...
                <View className='mt-10'>
                    <View className='relative self-center' style={{ width: 140, height: 140 }}>
                        ...
                        <TouchableOpacity className='absolute z-10 bottom-0 right-0 justify-center items-center' style={{ backgroundColor: ACCENT_COLOR, width: 50, height: 50, borderRadius: '50%' }}>
                            <Icon color={'white'} name='camera' type='entypo' size={20} />
                        </TouchableOpacity>
                    </View>
